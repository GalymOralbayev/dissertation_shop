...
namespace Shop.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        public AdminController(ProductService productService, OrderService orderService, UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager, RecDataService recDataService)
        {
        ...
        public IActionResult UpdateRecData() => View();

        [HttpPost]
        public async Task<IActionResult> UpdateRecDataAsync()
        {
            await recDataService.UpdateRecData();

            return RedirectToAction("UpdateRecData");
        }
    }
}
